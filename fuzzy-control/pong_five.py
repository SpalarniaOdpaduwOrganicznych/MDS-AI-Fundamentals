...
FPS = 120  # TO DO FIX ME CHANGE ME TO 30
TIME_SCALE = 2.0 # TO DO FIX ME DELETE ME
...
class Ball(Drawable):
    ...
    def move(self, board: Board, *args):
        # scale per-tick movement by TIME_SCALE
        ...
        # shorter collision cooldown at higher speeds (optional)
